...
public class moveCam : MonoBehaviour {
	...
	//public Events _isEsc1;
	public Text _Text;
	public bool _isEsc = false;
	//public bool _isEsc2 = false;
	...
	public void LateUpdate(){
		...
		if (target) {
			...
			Vector3 position = rotation * new Vector3 (0.0f, targetHeight + 0.1f, -distance) + target.position;
